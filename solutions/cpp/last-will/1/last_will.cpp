...
namespace estate_executor{
    int assemble_account_number(int secret_modifier){
        return khan::bank_number_part(secret_modifier)+zhang::
            bank_number_part(secret_modifier)+garcia::bank_number_part(secret_modifier);
    }
    int assemble_reds(){
        return khan::red::code_fragment()+zhang::red::code_fragment()+garcia::red::code_fragment();
    }
    int assemble_blues(){
        return khan::blue::code_fragment()+zhang::blue::code_fragment()+garcia::blue::code_fragment();
    }
    int assemble_code(){
        return assemble_reds()*assemble_blues();
    }
}